...
/datum/armor/armor_sf_sacrificial
	...
	bullet = BULLET_ARMOR_IV // When the level IV plates stop the bullet but not the energy transfer
...
/obj/item/clothing/suit/armor/sf_sacrificial
	name = "'Val' type IV ballistic vest"
...
/obj/item/sacrificial_face_shield
	name = "ballistic add-on face shield"
	desc = "A thick piece of glass with mounting points for snapping onto matching helmets. \

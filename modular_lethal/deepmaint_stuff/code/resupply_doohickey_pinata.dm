	...
	product_categories = list(
		list(
			...
			"products" = list(
				...
				/obj/item/stack/medical/gauze/alu_splint = INFINITY,
	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/organ/cyberimp/arm/toolkit/shell_launcher = INFINITY,
				/obj/item/organ/cyberimp/arm/toolkit/razorwire = INFINITY,

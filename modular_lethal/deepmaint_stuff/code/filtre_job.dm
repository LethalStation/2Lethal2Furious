...
/datum/job/lethal/filtre/after_spawn(mob/living/spawned, client/player_client)
	. = ..()
...
/datum/job/lethal/filtre/get_latejoin_spawn_point()
...
/datum/outfit/job/filtre
	name = "Filtre"
	jobtype = /datum/job/lethal/filtre
...
/datum/outfit/job/filtre/post_equip(mob/living/carbon/human/squaddie, visualsOnly = FALSE)
	...
	squaddie.faction |= FACTION_NANOTRASEN_PRIVATE
	return ..()

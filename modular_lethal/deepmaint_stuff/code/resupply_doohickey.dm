/obj/item/storage/belt/military/assault/lethalstation

/obj/item/storage/belt/military/assault/lethalstation/Initialize(mapload)
	. = ..()
	...
	product_categories = list(
		list(
			...
			"products" = list(
				...
				/obj/item/reagent_containers/applicator/patch/robotic_patch = INFINITY,
		...
		list(
			...
			"products" = list(
				...
				/obj/item/ammo_box/magazine/ammo_stack/s12gauge/prefilled/slug = INFINITY,
		...
		list(
			...
			"icon" = "hand",
			"products" = list(
				/obj/item/bodypart/arm/left/robot/surplus = INFINITY,
				/obj/item/bodypart/arm/right/robot/surplus = INFINITY,
				/obj/item/bodypart/leg/left/robot/surplus = INFINITY,
				/obj/item/bodypart/leg/right/robot/surplus = INFINITY,
			),
		),
	)
	contraband = list()
	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/storage/belt/military/assault/lethalstation = INFINITY,

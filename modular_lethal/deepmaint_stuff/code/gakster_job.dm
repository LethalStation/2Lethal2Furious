...
/datum/job/lethal/gakster/after_spawn(mob/living/spawned, client/player_client)
	. = ..()
...
/datum/outfit/job/gakster
	name = "Gakster"
	jobtype = /datum/job/lethal/gakster
	...
	backpack_contents = list(
		/obj/item/brick_phone_scryer/loaded/antag = 1,

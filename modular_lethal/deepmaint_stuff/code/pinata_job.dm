...
/datum/job/lethal/pinata/after_spawn(mob/living/spawned, client/player_client)
	. = ..()
...
/datum/job/lethal/pinata/get_latejoin_spawn_point()
...
/datum/outfit/job/pinata
	name = "Piñata"
	jobtype = /datum/job/lethal/pinata

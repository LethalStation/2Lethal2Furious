...
/obj/item/gun/ballistic/shotgun/riot/sol
	...
	desc = "A twelve gauge shotgun with a six shell capacity underneath. \
		Made for and used by Sol's various armed goons."
	...
	SET_BASE_PIXEL(-8, 0)
	fire_sound = 'modular_lethal/paxilweapons_real/sound/doesnt_miss/shotgun_heavy.ogg'
	rack_sound = 'modular_lethal/paxilweapons_real/sound/doesnt_miss/shotgun_rack.ogg'

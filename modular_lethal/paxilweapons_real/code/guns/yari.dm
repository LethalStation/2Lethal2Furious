...
/obj/item/gun/ballistic/automatic/suppressed_rifle
	...
	rack_sound = 'modular_lethal/paxilweapons_real/sound/yari/yari_rack.wav'
	fire_sound = 'modular_lethal/paxilweapons_real/sound/yari/yari.wav'
	suppressed_sound = 'modular_lethal/paxilweapons_real/sound/yari/yari.wav'
	can_suppress = TRUE

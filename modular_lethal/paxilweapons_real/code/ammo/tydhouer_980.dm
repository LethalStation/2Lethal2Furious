...
/obj/item/ammo_casing/c980grenade
	...
	icon = 'modular_lethal/paxilweapons_real/icons/casings.dmi'
	icon_state = "tyd_hedp"
...
/obj/projectile/bullet/c980grenade
	name = ".980 grenade"
	icon = 'modular_lethal/paxilweapons_real/icons/projectiles.dmi'
	icon_state = "bigshot"
	damage = 20
	stamina = 30
	range = 14
...
/obj/projectile/bullet/c980grenade/fuse_activation(atom/target)
	playsound(src, 'modular_lethal/paxilweapons_real/sound/kiboko/grenade_burst.ogg', 50, TRUE, 5)
...
/obj/projectile/bullet/c980grenade/shrapnel/fuse_activation(atom/target)
	...
	playsound(src, 'modular_lethal/paxilweapons_real/sound/kiboko/grenade_burst.ogg', 50, TRUE, -3)
	qdel(shrapnel_maker)
...
// .980 jamming beacon grenade

/obj/item/ammo_casing/c980grenade/beacon
	name = ".980 Tydhouer beacon grenade"
	desc = "A large grenade shell that will detonate at a range \
		given to it by the gun that fires it. Implants a radio jamming beacon into the nearest surface it detonates by."
	icon_state = "tyd_beacon"
	projectile_type = /obj/projectile/bullet/c980grenade/beacon

/obj/projectile/bullet/c980grenade/beacon
	/// What do we spawn on fuse
	var/beacon_to_spawn = /obj/item/detector_jammer

/obj/projectile/bullet/c980grenade/beacon/fuse_activation(atom/target)
	new beacon_to_spawn(get_turf(target))
	playsound(src, 'modular_lethal/paxilweapons_real/sound/kiboko/grenade_burst.ogg', 50, TRUE, -3)
